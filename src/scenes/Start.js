export default class Start extends Phaser.Scene
{
    ...
    completionCode: null
        ...
        this.instructionScreens = [
            ...
            'The location is scarce in natural resources and does not always have enough food for everyone in the group to survive.',
...
showEqualDivisionTask ()
{
    ...
    this.equalDivisionBlanket = this.add.rectangle(640, 195, 500, 130, 0xd8ecff);
    ...
    const blanketLabel = this.add.text(640, 195, 'Blanket', {
        fontSize: '24px',
        color: '#000000'
    }).setOrigin(0.5);
